    ...
    return(
        <div className="w-full bg-white py-10">
            <div className="h-[90px]">
                <h1 className="md:max-w-[1028px] max-w-[600px]  m-auto border-b pb-2 text-[21px] font-medium">OUR SPECIALTIES</h1>
            </div>
            <div className=" md:max-w-[1028px] max-w-[600px]  m-auto pb-2  ">
            ...
            <div className=" md:max-w-[1028px] max-w-[600px]  m-auto pb-4 ">
                <div className="flex">
                    <span className="pr-3 sticky top-0 "><img src={shield}/></span>
            ...
            <div className=" md:max-w-[1028px] max-w-[600px]  m-auto pb-2 pt-5 ">
                        {/* <h1 className="text-[18px] pb-5">Full scale organization website</h1> */}
            ...
            <div className=" md:max-w-[1028px] max-w-[600px]  m-auto pb-4 ">
                <div className="flex">
                    <span className="pr-3 sticky top-0 "><img src={tick}/></span>
